...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Checks if creating an instaance city with no arguments is successful"""
        self.assertEqual(City, type(City()))


    def test_new_instance_stored_in_objects(self):
        """confirms that the new instance created is stored in the models.storage"""
        self.assertIn(City(), models.storage.all().values())


    def test_id_is_public_str(self):
        """Ensures that the string attribute is a string"""
        self.assertEqual(str, type(City().id))


    def test_created_at_is_public_datetime(self):
        """checks if created at is of type datetime"""
        self.assertEqual(datetime, type(City().created_at))


    def test_updated_at_is_public_datetime(self):
        """ Checks if the updated_at attribute is of type datetime."""
        self.assertEqual(datetime, type(City().updated_at))


    def test_state_id_is_public_class_attribute(self):
        """Validates the city attribute and the state id"""
        cy = City()
    ...
    def test_name_is_public_class_attribute(self):
        """Validates that City has a name attribute, and it is not present in the instance's __dict__."""
        cy = City()
